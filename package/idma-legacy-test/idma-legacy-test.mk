...
IDMA_LEGACY_TEST_CPPFLAGS = \
	-DIDMA_LEGACY_TEST_EXPECT_CMO=$(if $(BR2_PACKAGE_IDMA_LEGACY_TEST_EXPECT_CMO),1,0)

define IDMA_LEGACY_TEST_BUILD_CMDS
	$(MAKE) CC="$(TARGET_CC)" \
		CFLAGS="$(TARGET_CFLAGS) -march=rv64gc_zicbom_zicboz $(IDMA_LEGACY_TEST_CPPFLAGS)" \
		-C $(@D)
endef
